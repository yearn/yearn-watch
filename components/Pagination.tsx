	...
	return (
		<>
			<div className={'flex flex-1 justify-between sm:hidden'}>
				<a
					href={'#'}
					className={'border-gray-300 hover:bg-gray-50 relative inline-flex items-center rounded-md border px-4  py-2 text-sm font-medium text-white'}
				>
					{'Previous'}
				</a>
				<a
			...
			<div className={'sm-border hidden sm:flex sm:items-center sm:justify-center'}>
				...
				<ReactPaginate
					...
					pageLinkClassName={'text-white hover:border-b-2 inline-flex items-end mx-1.5 mt-2.5 px-0.5 text-xs'}
					previousLinkClassName={'inline-flex items-center m-2 font-medium'}
					nextLinkClassName={'inline-flex items-center m-2 font-medium'}
					breakLinkClassName={'text-white inline-flex items-center mx-2 my-2 px-0.5 font-medium'}
					activeLinkClassName={'font-bold border-b-2 items-center mx-2 my-2 px-0.5 md:inline-flex'}
