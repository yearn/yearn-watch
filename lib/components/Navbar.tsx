...
export default function Navbar({options, logo, title, selected, set_selected, children, ...props}: TNavbarProps): ReactElement {
	...
	return (
		<aside className={'relative top-0 pt-0 w-auto min-w-full md:sticky md:pt-9 md:w-40 md:min-w-[10rem]'} {...props}>
			...
			<div className={'flex flex-row justify-between items-center p-4 bg-surface border-b border-background-variant md:hidden'}>
				<Link href={'/'}>
					<div className={'flex flex-row items-center cursor-pointer'}>
						<div className={title ? 'mr-4' : ''}>
